...
A category's status does not express a linear sequence, but a set of mutually combining flags that together determine to whom the category is displayed:
